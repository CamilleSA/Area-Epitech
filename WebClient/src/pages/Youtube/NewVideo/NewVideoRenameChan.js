...
class NewVideoRenameChan extends Component {
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewVideoRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPopular", "reaction": "renameChannel"
        });
...
export default NewVideoRenameChan;