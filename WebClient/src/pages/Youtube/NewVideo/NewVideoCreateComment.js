...
class NewVideoCreateComment extends Component {
    ...
    createArea = () => {
        ...
        var objAction = {};
        var objReaction = { token: tokenGithub, owner: this.state.user, repo: this.state.role }
        var tmp = username + 'NewVideoDeleteRepo' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPopular", "reaction": "deleteRepo"
        });
...
export default NewVideoCreateComment;