...
class NewVideoCreateIssue extends Component {
    ...
    createArea = () => {
        ...
        var objAction = {};
        var objReaction = { token: tokenGithub, owner: this.state.user, repo: this.state.role }
        var tmp = username + 'NewVideoCreateIssue' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPopular", "reaction": "createIssue"
        });
...
export default NewVideoCreateIssue;