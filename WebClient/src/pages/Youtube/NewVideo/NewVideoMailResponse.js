...
class NewVideoMailResponse extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = {};
        var objReaction = {}
        var tmp = username + 'NewVideoRespondMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPopular", "reaction": "respondMail"
        });
...
export default NewVideoMailResponse;