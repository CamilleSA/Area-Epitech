...
class NewVideoChanSendMail extends Component {
    ...
    modifyArea = () => {
        ...
        var objAction = { channelName: this.state.city };
        var objReaction = { mail: this.state.user }
    ...
    createArea = () => {
        ...
        var objAction = { channelName: this.state.city };
        var objReaction = { mail: this.state.user }
        var tmp = username + 'NewVideoChannelSendMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInChannel", "reaction": "sendMail"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">1. New Video in Channel in Youtube</h1>
                        <h1 className="account">Enter your Information</h1>
                        <input type="email" onChange={(text) => { this.handleCity(text) }} autoFocus placeholder="Enter Channel" name="email" className="input-youtube"></input>
                    </div>
                </div>
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" onChange={(text) => { this.handleUser(text) }} autoFocus placeholder="Enter Email User" name="email" className="input-mail"></input>
                    </div>  </div>
...
export default NewVideoChanSendMail;