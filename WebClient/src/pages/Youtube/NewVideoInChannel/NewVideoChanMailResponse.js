...
class NewVideoChanMailResponse extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { channelName: this.state.email };
        var objReaction = {}
        var tmp = username + 'NewVideoChannelRespondMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInChannel", "reaction": "respondMail"
        });
...
export default NewVideoChanMailResponse;