...
class NewVideoChanRenameChan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    modifyArea = () => {
        ...
        var objAction = { channelName: this.state.email };
    ...
    createArea = () => {
        ...
        var objAction = { channelName: this.state.email };
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user }
        var tmp = username + 'NewVideoChannelRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInChannel", "reaction": "renameChannel"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" onChange={(text) => { this.handleEmail(text) }} autoFocus placeholder="Enter Channel" name="email" className="input-youtube"></input>
                    </div>
                </div>
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">2. Rename an Channel to Discord</h1>
                        <h1 className="account">Enter your information</h1>
...
export default NewVideoChanRenameChan;