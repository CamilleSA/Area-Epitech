...
class NewVideoChanCreateIssue extends Component {
    ...
    createArea = () => {
        ...
        var objAction = { channelName: this.state.email };
        var objReaction = { token: tokenGithub, owner: this.state.user, repo: this.state.role }
        var tmp = username + 'NewVideoChannelCreateIssue' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInChannel", "reaction": "createIssue"
        });
...
export default NewVideoChanCreateIssue;