...
class NewVideoChanDelLabel extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"youtube-delete-label-video-channel","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
            <div className="mid-dashboard">
                ...
                <img className="gmaile" src={Youtube} alt="gmail"/> 
                    ...
                    <button type="submit" name="submit" className="youtube-bten"><i className="fa fa-youtube-play"> </i> Sign In to Youtube</button>
                </div>
            </div>
...
export default NewVideoChanDelLabel;