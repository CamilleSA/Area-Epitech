...
class NewVideoPlaylistCreateComment extends Component {
    ...
    createArea = () => {
        ...
        var objAction = { id: this.state.email };
        var objReaction = { token: tokenGithub, owner: this.state.user, repo: this.state.role }
        var tmp = username + 'NewVideoPlaylistDeleteRepo' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPlaylist", "reaction": "deleteRepo"
        });
...
export default NewVideoPlaylistCreateComment;