...
class NewVideoPlaylistCreateLabel extends Component {
    ...
    render() {
        ...
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"youtube-create-label-video-playlist","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
...
export default NewVideoPlaylistCreateLabel;