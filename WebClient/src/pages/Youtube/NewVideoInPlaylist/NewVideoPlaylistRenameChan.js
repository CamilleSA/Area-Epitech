...
class NewVideoPlaylistRenameChan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { id: this.state.email };
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user }
        var tmp = username + 'NewVideoPlaylistRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPlaylist", "reaction": "renameChannel"
        });
...
export default NewVideoPlaylistRenameChan;