...
class NewVideoPlaylistAddRole extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { id: this.state.email };
        var objReaction = { idServer: this.state.serverReaction, idUser: this.state.user, idRole: this.state.role }
        var tmp = username + 'NewVideoPlaylistAddRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPlaylist", "reaction": "addRole"
        });
...
export default NewVideoPlaylistAddRole;