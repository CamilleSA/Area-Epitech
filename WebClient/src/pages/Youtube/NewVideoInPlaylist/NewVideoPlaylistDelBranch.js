...
class NewVideoPlaylistDelBranch extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { id: this.state.email };
        var objReaction = { token: tokenGithub, owner: this.state.user, repo: this.state.role, issue: this.state.channel }
        var tmp = username + 'NewVideoPlaylistCreateComment' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPlaylist", "reaction": "createComment"
        });
...
export default NewVideoPlaylistDelBranch;