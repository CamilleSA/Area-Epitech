...
class NewVideoPlaylistLinkPost extends Component {
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewVideoPlaylistLinkPost' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPlaylist", "reaction": "postMessage"
        });
    ...
    render() {
        ...
        return (
            <div className="mid-dashboard">
                ...
                <button type="submit" name="submit" className="tryte" onClick={() => { this.createArea() }}><a href="#popup1"> Make a Area !</a></button>
...
export default NewVideoPlaylistLinkPost;