...
class NewVideoPlaylistSendMail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { id: this.state.city };
        var objReaction = { mail: this.state.email }
        var tmp = username + 'NewVideoPlaylistSendMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "newVideoInPlaylist", "reaction": "sendMail"
        });
...
export default NewVideoPlaylistSendMail;