...
class NewLabelDeleteLabel extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"gmail-new-label-delete-label","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
            ...
            <div className="cardu">
                ...
                <img className="gmaile" src={Gmail} alt="gmail"/> 
                    ...
                    <h1 className="trigger">2. Delete Create an Label of Email to Gmail</h1>
...
export default NewLabelDeleteLabel;