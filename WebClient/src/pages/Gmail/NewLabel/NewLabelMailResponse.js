...
class NewLabelMailResponse extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"gmail-new-label-mail-response","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
           ...
           <input type="email" autoFocus placeholder="Enter Email User" name="email" className="input-mail"></input>
           <input type="email" autoFocus placeholder="Enter Email Object" name="email" className="input-mail"></input>
           <input type="email" autoFocus placeholder="Enter Message" name="email" className="input-mail"></input>                   </div>
            </div>
...
export default NewLabelMailResponse;