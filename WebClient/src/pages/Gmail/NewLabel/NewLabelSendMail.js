...
class NewLabelSendMail extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"gmail-new-label-send-mail","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
...
export default NewLabelSendMail;