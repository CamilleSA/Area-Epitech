...
const githubSignin = (result) => {
    ...
    .then(function(result) {
        ...
        var raw = JSON.stringify({"placeholder":"gmail-create-issue-new-label","service":"github","token":result.credential.accessToken});
        var requestOptions = {
          method: 'POST',
          headers: myHeaders,
          body: raw,
...
class NewLabelCreateIssue extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"gmail-new-label-create-issue","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
...
export default NewLabelCreateIssue;