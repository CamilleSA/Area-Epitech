...
class NewLabelRenameChan extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"gmail-new-label-rename-channel","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
            ...
            <div className="cardu">
                ...
                <img className="gmaile" src={Discord} alt="gmail"/> 
                    ...
                    <input type="email" autoFocus placeholder="Enter Name" name="email" className="input-server"></input>   </div>
            </div>
...
export default NewLabelRenameChan;