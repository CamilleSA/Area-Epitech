...
class NewLabelRemoveRole extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"gmail-new-label-remove-role","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
            ...
            <div className="cardu">
                ...
                <img className="gmaile" src={Discord} alt="gmail"/> 
                    ...
                    <input type="email" autoFocus placeholder="Enter ID User" name="email" className="input-server"></input>
                    <input type="email" autoFocus placeholder="Enter ID Role" name="email" className="input-server"></input> </div>
            </div>
...
export default NewLabelRemoveRole;