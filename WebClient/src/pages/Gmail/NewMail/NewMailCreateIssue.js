...
class NewMailCreateIssue extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewMailCreateIssue' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getMail", "reaction": "createIssue"
        });
...
export default NewMailCreateIssue;