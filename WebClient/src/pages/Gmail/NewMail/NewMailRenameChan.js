...
class NewMailRenameChan extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = {};
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user };
        var tmp = username + 'NewMailRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        this.setState({ placeholder: tmp })

        var raw = JSON.stringify({
            "username": username, "placeholder": tmp, "serviceAction": "gmail",
            "serviceActionConfig": objAction, "serviceReaction": "discord",
            "serviceReactionConfig": objReaction,
            "action": "getMail", "reaction": "renameChannel"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">1. New Mail in Gmail</h1>
                    </div>
                </div>
...
export default NewMailRenameChan;