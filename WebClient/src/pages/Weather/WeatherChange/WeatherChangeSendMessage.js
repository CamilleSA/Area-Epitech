...
class WeatherChangeSendMessage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { name: this.state.city };
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user }
        var tmp = username + 'WeatherSendMessage' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getWeather", "reaction": "sendMessage"
        });
...
export default WeatherChangeSendMessage;