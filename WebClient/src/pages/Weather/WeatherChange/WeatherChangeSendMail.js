...
class WeatherChangeSendMail extends Component {
    ...
    createArea = () => {
        ...
        var objAction = { name: this.state.city };
        var objReaction = { mail: this.state.email }
        var tmp = username + 'WeatherSendMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getWeather", "reaction": "sendMail"
        });
...
export default WeatherChangeSendMail;