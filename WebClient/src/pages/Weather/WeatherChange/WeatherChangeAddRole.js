...
class WeatherChangeAddRole extends Component {
    ...
    createArea = () => {
        ...
        var objAction = { name: this.state.city };
        var objReaction = { idServer: this.state.serverReaction, idUser: this.state.user, idRole: this.state.role }
        var tmp = username + 'WeatherAddRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getWeather", "reaction": "addRole"
        });
...
export default WeatherChangeAddRole;