...
class ItIsRainingRenameChan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { name: this.state.city };
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user }
        var tmp = username + 'BadWeatherRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getBadWeather", "reaction": "renameChannel"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" onChange={(text) => { this.handleCity(text) }} autoFocus placeholder="Enter City Name" name="email" className="city-input" required></input>
                    </div>
                </div>
...
export default ItIsRainingRenameChan;