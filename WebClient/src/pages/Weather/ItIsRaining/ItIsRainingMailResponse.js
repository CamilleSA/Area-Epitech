...
class ItIsRainingMailResponse extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        ...
        var objAction = { name: this.state.city };
        var objReaction = {}
        var tmp = username + 'BadWeatherRespondMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getBadWeather", "reaction": "respondMail"
        });
...
export default ItIsRainingMailResponse;