...
class ItIsRainingCreateIssue extends Component {
    constructor(props) {
        super(props);
        this.state = {
            city: '',
    ...
    createArea = () => {
        var tokenGithb = "f45564ee326713db9ced7c452f3afb3c7c2320e8";
        ...
        var objAction = { name: this.state.city };
        var objReaction = { token: tokenGithb, owner: this.state.user, repo: this.state.role }
        var tmp = username + 'BadWeatherCreateIssue' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getBadWeather", "reaction": "createIssue"
        });
...
export default ItIsRainingCreateIssue;