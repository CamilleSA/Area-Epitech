...
class ItIsRainingAddRole extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'BadWeatherAddRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "action": "getBadWeather", "reaction": "addRole"
        });
...
export default ItIsRainingAddRole;