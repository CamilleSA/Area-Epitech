...
class CreateOrganisationSendMail extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewOrgaSendMail' + Math.floor((Math.random() * 1000) + 1);
        this.setState({ placeholder: tmp })


        var raw = JSON.stringify({
            "username": username, "placeholder": tmp, "serviceAction": "github",
            "serviceActionConfig": objAction, "serviceReaction": "google",
            "serviceReactionConfig": objReaction,
            "action": "getOrganization", "reaction": "sendMail"
        });
...
export default CreateOrganisationSendMail;
