...
class CreateOrganisationRemoveRole extends Component {
    constructor(props) {
        super(props);
    ...
    modifyArea = () => {
        ...
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json; charset=UTF-8");
        var objAction = { token: tokenGithub };
    ...
    createArea = () => {
        ...
        var objAction = { token: tokenGithub };
        var objReaction = { idServer: this.state.serverReaction, idUser: this.state.user, idRole: this.state.role };
        var tmp = username + 'NewOrgaRemoveRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getOrganization", "reaction": "removeRole"
        });
    ...
    executeArea = () => {
        ...
        var raw = JSON.stringify({ "username": username, "placeholder": username + 'NewOrgaRemoveRole' });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">1. New Organization   in Github</h1>
...
export default CreateOrganisationRemoveRole;