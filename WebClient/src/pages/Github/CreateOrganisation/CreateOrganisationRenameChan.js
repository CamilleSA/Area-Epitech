...
class CreateOrganisationRenameChan extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewOrgaRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getOrganization", "reaction": "renameChannel"
        });
...
export default CreateOrganisationRenameChan;