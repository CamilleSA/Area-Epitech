...
class CreateOrganisationMailResponse extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewOrgaMailResponse' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getOrganization", "reaction": "respondMail"
        });
    ...
    executeArea = () => {
        ...
        var raw = JSON.stringify({ "username": username, "placeholder": username + 'NewOrgaMailResponse' });
...
export default CreateOrganisationMailResponse;