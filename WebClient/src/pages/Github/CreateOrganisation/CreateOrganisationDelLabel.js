...
const githubSignin = (result) => {
    ...
    .then(function(result) {
        ...
        var raw = JSON.stringify({"placeholder":"github-create-orga-delete-label","service":"github","token":result.credential.accessToken});
        var requestOptions = {
          method: 'POST',
          headers: myHeaders,
          body: raw,
...
class CreateOrganisationDelLabel extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"github-delete-label-create-orga","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
            <div className="mid-dashboard">
                ...
                <img className="gmaile" src={Github} alt="gmail"/> 
                    ...
                    <h1 className="trigger">1. New Organization   to Github</h1>
...
export default CreateOrganisationDelLabel;