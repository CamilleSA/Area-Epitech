...
class CreateBranchMailResponse extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewBranchMailResponse' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewBranch", "reaction": "respondMail"
        });
...
export default CreateBranchMailResponse;