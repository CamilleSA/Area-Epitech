...
class CreateBranchRenameChan extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = { token: tokenGithub, owner: this.state.name, repo: this.state.repo };
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user };
        var tmp = username + 'NewBranchRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewBranch", "reaction": "renameChannel"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">1. New Branch in Github</h1>
...
export default CreateBranchRenameChan;