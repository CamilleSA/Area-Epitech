...
class CreateCommitAddRole extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewCommitAddRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getCommit", "reaction": "addRole"
        });
...
export default CreateCommitAddRole;