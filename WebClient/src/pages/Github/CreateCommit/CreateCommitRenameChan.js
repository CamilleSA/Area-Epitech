...
class CreateCommitRenameChan extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = { token: tokenGithub, owner: this.state.name, repo: this.state.repo };
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user };
        var tmp = username + 'NewCommitRenameChannel' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getCommit", "reaction": "renameChannel"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">1. New Commit in Github</h1>
                        ...
                        <input type="email" onChange={(text) => { this.handleRepo(text) }} autoFocus placeholder="Enter Repository" name="email" className="input-branche"></input></div>
...
export default CreateCommitRenameChan;