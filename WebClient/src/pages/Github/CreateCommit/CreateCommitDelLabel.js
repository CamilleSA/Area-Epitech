...
const githubSignin = (result) => {
    ...
    .then(function(result) {
        ...
        var raw = JSON.stringify({"placeholder":"github-create-commit-delete-label","service":"github","token":result.credential.accessToken});
        var requestOptions = {
          method: 'POST',
          headers: myHeaders,
          body: raw,
...
class CreateCommitDelLabel extends Component {
    ...
    render() {
        ...
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"github-delete-label-create-commit","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        return (
            <div className="mid-dashboard">
                ...
                <img className="gmaile" src={Github} alt="gmail"/> 
                    ...
                    <h1 className="trigger">1. New Commit to Github</h1>
                    ...
                    <input type="email" autoFocus placeholder="Enter Username" name="email" className="input-branch"></input>
                    <input type="email" autoFocus placeholder="Enter Repository" name="email" className="input-branche"></input></div>
            </div>
            ...
            <div className="cardu">
                ...
                <img className="gmaile" src={Gmail} alt="gmail"/> 
                    ...
                    <h1 className="trigger">2. Delete an Label of Email to Gmail</h1>
                    <h1 className="account">Choose account</h1>
                    <GoogleLogin
...
export default CreateCommitDelLabel;