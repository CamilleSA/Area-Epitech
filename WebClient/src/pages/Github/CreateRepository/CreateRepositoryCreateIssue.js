...
class CreateRepositoryCreateIssue extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewRepoCreateIssue' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewRepo", "reaction": "createIssue"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="account1">Enter your Information</h1>
                        <input type="email" onChange={() => { this.handleUser() }} autoFocus placeholder="Enter Username" name="email" className="input-branch"></input>
                        <input type="email" onChange={() => { this.handleRole() }} autoFocus placeholder="Enter Repository" name="email" className="input-branche"></input>
                    </div>
                </div>
...
export default CreateRepositoryCreateIssue;