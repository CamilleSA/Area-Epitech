...
const githubSignin = (result) => {
    ...
    .then(function(result) {
        ...
        var raw = JSON.stringify({"placeholder":"github-create-repo-delete-label","service":"github","token":result.credential.accessToken});
        var requestOptions = {
          method: 'POST',
          headers: myHeaders,
          body: raw,
...
class CreateRepositoryDelLabel extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"github-delete-label-create-repo","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
...
export default CreateRepositoryDelLabel;