...
class CreateRepositoryAddRole extends Component {
    ...
    createArea = () => {
        ...
        var objAction = { token: tokenGithub, owner: this.state.name };
        var objReaction = { idServer: this.state.serverReaction, idUser: this.state.user, idRole: this.state.role };
        var tmp = username + 'NewRepoAddRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewRepo", "reaction": "addRole"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" autoFocus placeholder="Enter Username" name="email" className="input-github" onChange={(text) => { this.handleName(text) }}></input>
                    </div>
                </div>
...
export default CreateRepositoryAddRole;