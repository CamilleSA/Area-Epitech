...
class CreateRepositoryMailResponse extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewRepoMailResponse' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewRepo", "reaction": "respondMail"
        });
...
export default CreateRepositoryMailResponse;