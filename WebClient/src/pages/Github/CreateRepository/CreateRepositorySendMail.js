...
class CreateRepositorySendMail extends Component {
    constructor(props) {
        super(props);
    ...
    modifyArea = () => {
        ...
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json; charset=UTF-8");
        var objAction = { token: tokenGithub, owner: this.state.user };
        var objReaction = { mail: this.state.role }
    ...
    createArea = () => {
        ...
        var tmp = username + 'NewRepoSendMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewRepo", "reaction": "sendMail"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" onChange={(text) => { this.handleUser(text) }} autoFocus placeholder="Enter Username" name="email" className="input-github"></input>
                    </div>
                </div>
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" onChange={(text) => { this.handleRole(text) }} autoFocus placeholder="Enter Email User" name="email" className="input-mail"></input>
                    </div></div>
...
export default CreateRepositorySendMail;