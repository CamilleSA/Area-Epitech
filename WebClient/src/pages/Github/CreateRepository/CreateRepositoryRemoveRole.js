...
class CreateRepositoryRemoveRole extends Component {
    ...
    handleServerAction(text) {
        this.setState({ serverAction: text.target.value })
    ...
    modifyArea = () => {
        ...
        var myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json; charset=UTF-8");
        var objAction = { token: tokenGithub, owner: this.state.serverAction };
    ...
    createArea = () => {
        ...
        var objAction = { token: tokenGithub, owner: this.state.serverAction };
        var objReaction = { idServer: this.state.serverReaction, idUser: this.state.user, idRole: this.state.role };
        var tmp = username + 'NewRepoRemoveRole' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "getNewRepo", "reaction": "removeRole"
        });
            ...
            <div className="mid-dashboard">
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <input type="email" autoFocus placeholder="Enter Username" name="email" className="input-github" onChange={(text) => { this.handleServerAction(text) }}></input>
                    </div>
                </div>
                ...
                <div className="cardu">
                    <div className="container">
                        ...
                        <h1 className="trigger">2. Remove Role of User to Discord</h1>
                        ...
                        <input type="email" autoFocus placeholder="Enter ID Server" name="email" className="input-server" onChange={(text) => { this.handleServerReaction(text) }}></input>
                        <input type="email" autoFocus placeholder="Enter ID User" name="email" className="input-server" onChange={(text) => { this.handleUser(text) }}></input>
                        <input type="email" autoFocus placeholder="Enter ID Role" name="email" className="input-server" onChange={(text) => { this.handleRole(text) }}></input> </div>
                </div>
...
export default CreateRepositoryRemoveRole;