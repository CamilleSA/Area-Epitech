...
class SearchArtistsSendMessage extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = {name: this.state.name};
        var objReaction = { idServer: this.state.serverReaction, idChannel: this.state.user };
        var tmp = username + 'searchArtistsSendMessage' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "searchArtists", "reaction": "sendMessage"
        });
...
export default SearchArtistsSendMessage;