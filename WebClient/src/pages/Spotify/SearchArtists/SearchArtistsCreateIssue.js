...
class SearchArtistsCreateIssue extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objReaction = { token: tokenGithub, owner: this.state.user, repo: this.state.role }
        var tmp = username + 'searchArtistsCreateIssue' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "searchArtists", "reaction": "createIssue"
        });
...
export default SearchArtistsCreateIssue;