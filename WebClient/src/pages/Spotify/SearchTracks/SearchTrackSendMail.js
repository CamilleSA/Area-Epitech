...
class SearchTrackSendMail extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = {name: this.state.name};
        var objReaction = { mail: this.state.mail }
        var tmp = username + 'searchTracksSendMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "searchTracks", "reaction": "sendMail"
        });
...
export default SearchTrackSendMail;