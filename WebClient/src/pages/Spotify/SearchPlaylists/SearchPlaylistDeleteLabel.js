...
class SearchPlaylistsDelLabel extends Component {
    ...
    render() {
        const OnSuccess = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"reddit-delete-label-comment-user","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
        ...
        const OnSuccess1 = (response) => {
           ...
           var myHeaders = new Headers();
            ...
            var raw = JSON.stringify({"placeholder":"reddit-comment-user-delete-label","service":"google","token":response.accessToken});
            var requestOptions = {
              method: 'POST',
              headers: myHeaders,
              body: raw,
...
export default SearchPlaylistsDelLabel;