...
class SearchPlaylistsSendMail extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = {name: this.state.name};
        var objReaction = { mail: this.state.mail }
        var tmp = username + 'searchPlaylistsSendMail' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "searchPlaylists", "reaction": "sendMail"
        });
...
export default SearchPlaylistsSendMail;