...
class SearchPlaylistsMailResponse extends Component {
    constructor(props) {
        super(props);
    ...
    createArea = () => {
        ...
        var objAction = {name: this.state.name};
        var objReaction = {}
        var tmp = username + 'searchPlaylistsMailResponse' + Math.floor((Math.random() * 1000) + 1);
        ...
        var raw = JSON.stringify({
            ...
            "serviceReactionConfig": objReaction,
            "action": "searchPlaylists", "reaction": "respondMail"
        });
...
export default SearchPlaylistsMailResponse;