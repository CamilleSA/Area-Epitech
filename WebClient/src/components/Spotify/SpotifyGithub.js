...
class SpotifyGithubServices extends Component {
...
<div class="box">
  ...
  <option value="hide" selected className="nose">Select an Action ...</option>
    ...
    <option value="6" className="Spotify">&#xf09b; New Organization  </option>
...
<If condition={  this.state.value == 2  && this.state.value2 == 9}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Playlist in Spotify, Create Comment to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchplaylists-deletebranch">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 2 && this.state.value2 == 10 }>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Playlist in Spotify, Create Issue to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchplaylists-createissue">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 2 && this.state.value2 == 11}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Playlist in Spotify, Delete Repository to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchplaylists-createcomment">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 1  && this.state.value2 == 9}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Artist in Spotify, Create Comment to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchartists-deletebranch">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 1 && this.state.value2 == 10 }>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Artist in Spotify, Create Issue to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchartists-createissue">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 1 && this.state.value2 == 11}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Artist in Spotify, Delete Repository to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchartists-createcomment">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4  && this.state.value2 == 9}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Track in Spotify, Create Comment to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchtracks-deletebranch">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4 && this.state.value2 == 10 }>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Track in Spotify, Create Issue to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchtracks-createissue">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4 && this.state.value2 == 11}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">Search Track in Spotify, Delete Repository to Github</h1>

                <h2 className="subdetailes">Spotify   +  Github</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./searchtracks-createcomment">Make a Area !</a></button>
...
export default SpotifyGithubServices;