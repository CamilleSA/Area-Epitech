...
class YoutubeDiscordServices extends Component {
...
<If condition={  this.state.value == 1  && this.state.value2 == 6}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Youtube, Add Role in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideo-addrole">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 1  && this.state.value2 == 7}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Youtube, Remove Role of User in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideo-removerole">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 1  && this.state.value2 == 8}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Youtube, Send Message in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideo-sendmessage">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 1  && this.state.value2 == 9}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Youtube, Rename an Channel in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideo-renamechan">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 2  && this.state.value2 == 6}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Channel in Youtube, Add Role in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideochan-addrole">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 2  && this.state.value2 == 7}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Channel in Youtube, Remove Role of User in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideochan-removerole">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 2  && this.state.value2 == 8}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Channel in Youtube, Send Message in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideochan-sendmessage">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 2  && this.state.value2 == 9}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Channel in Youtube, Rename an Channel in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideochan-renamechan">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4  && this.state.value2 == 6}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Playlist in Youtube, Add Role in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideoplaylist-addrole">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4  && this.state.value2 == 7}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Playlist in Youtube, Remove Role of User in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideoplaylist-removerole">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4  && this.state.value2 == 8}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Playlist in Youtube, Send Message in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideoplaylist-sendmessage">Make a Area !</a></button>
        ...
        <If condition={  this.state.value == 4  && this.state.value2 == 9}>
          ...
          <div className="cardi">
                ...
                <h1 className="details">New Video in Playlist in Youtube, Rename an Channel in Discord</h1>

                <h2 className="subdetailes">Youtube   +  Discord</h2>
                </div>
                <button type="submit" name="submit" className="tryite"><a className="sign-link" href="./newvideoplaylist-renamechan">Make a Area !</a></button>
...
export default YoutubeDiscordServices;