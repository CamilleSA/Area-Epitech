...
class DiscordGmailServices extends Component {
...
<div class="box">
  ...
  <option value="4" className="Weather">&#xf0e0; New Label</option>
...
<div class="boxi">
  ...
  <option value="hide" selected className="nose">Select an Reaction ...</option>
    ...
    <option value="18" className="Discord">&#xf0e0; Create an Label</option>
    <option value="19" className="Discord">&#xf0e0; Delete an Label of Email</option>
...
export default DiscordGmailServices;