...
class _LoginState extends State<Login> {
        ...
        return new AlertDialog(
          ...
          content: new SingleChildScrollView(
            child: new ListBody(
              children: [
                new Text(
                    'Either email or password are wrong, or you don\'t have account.'),
              ],
            ),
          ),
          actions: [
  ...
  void LogToBackGoogle() async {
    ...
    if (response.statusCode == 200) {
      var truc = jsonDecode(response.body);
      globals.username = truc['username'];
      ...
      var get_area = list_area.statusCode;
      print(get_area);
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      hintText: "Adrianne@ex.com or Adrianne",
                                      hintStyle: TextStyle(
...
class InputMailWidget extends StatelessWidget {
  ...
  InputMailWidget(this.topRight, this.bottomRight);
...
const List<Color> signInGradientsDark = [
  Color(0xFF62a7fd),
  Color(0xFF431c9e),
];
